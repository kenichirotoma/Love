...
class FootstempsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_footstemps)
        ...
        val footstempsList = listOf(
            ...
            val list = findViewById<ListView>(R.id.footstempslist)
            list.onItemClickListener = ListItemClickListener()
            list.adapter = MyListAdapter(this, footstempsList, R.layout.listitem)
    ...
    private inner class ListItemClickListener : AdapterView.OnItemClickListener {
        override fun onItemClick(parent: AdapterView<*>, view: View, position: Int, id: Long) {
            ...
            // インテントオブジェクトを生成。
            val ProfilePape = Intent(this@FootstempsActivity, ProfileActivity::class.java)
